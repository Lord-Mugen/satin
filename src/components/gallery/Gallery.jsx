...
const Gallery = () => {
  return (
    <section className="gallery grid grid-cols-3 gap-4 h-3/5 py-2 px-2 lg:py-0 lg:px-0">
      <div className="gallery__column">
        <img src={Recurso20} alt="imagen de galeria" />
      </div>
      <div className="gallery__column col-span-1 grid grid-rows-2 gap-2">
        <div className="">
          <img src={Recurso21} alt="imagen de galeria" />
        </div>
        <div className="">
          <img src={Recurso22} alt="imagen de galeria" />
        </div>
      </div>
      <div className="gallery__column">
        <img src={Recurso23} alt="imagen de galeria" />
      </div>
    </section>
  );
};
